                    ...
                    <div class="row rounded-lg overflow-hidden shadow">
                        ...
                        <div class="px-4 py-5 chat-box bg-white">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="text-small mb-0 text-muted">Chat 1</p>
                                </div>
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-small mb-0 text-white">Chat 2</p>
                                </div>
                                <p class="small text-muted">12:00 PM | Aug 13</p>
                            </div>
                            </div>
                            ...
                            <div class="media-body ml-3">
                                <div class="bg-light rounded py-2 px-3 mb-2">
                                <p class="text-small mb-0 text-muted">Chat 3</p>
                                </div>
                                <p class="small text-muted">12:00 PM | Aug 13</p>
                            </div>
                            </div>
                            ...
                            <div class="media-body">
                                <div class="bg-primary rounded py-2 px-3 mb-2">
                                <p class="text-small mb-0 text-white">Chat 4</p>
                                </div>
                                <p class="small text-muted">12:00 PM | Aug 13</p>
                            </div>
                            </div>
                            ...
                            <div class="media-body ml-3">
                                <div class="bg-light rounded py-2 px-3 mb-2">
                                <p class="text-small mb-0 text-muted">Chat 5</p>
                                </div>
                                <p class="small text-muted">12:00 PM | Aug 13</p>
                            </div>
                            </div>
                            ...
                            <div class="media-body">
                                <div class="bg-primary rounded py-2 px-3 mb-2">
                                <p class="text-small mb-0 text-white">Chat 6</p>
                                </div>
                                <p class="small text-muted">12:00 PM | Aug 13</p>
                            </div>
                            </div>
