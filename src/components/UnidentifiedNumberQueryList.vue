<template>
    <div>
            ...
            <div class="card-body">
                <div class="card-body">
                    <div class="bg-gray px-4 py-2 bg-light">
                        <p class="h5 mb-0 py-1">Unknown Query</p>
                    </div>
                                    ...
                                    <div class="media">
                                        <div class="media-body ml-4">
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                                <button type="button" class="btn" data-toggle="modal" data-target="#showModalNumber" @click="unknownFAQButton(unidentified)">
                                                    <h6 class="mb-0">
        ...
        <!-- Details modal -->
        <div class="modal fade" id="showModalNumber" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" ref="edit-modal">
...
<script>
    ...
    export default {
        name:'UnidentifiedNumberQueryList',
