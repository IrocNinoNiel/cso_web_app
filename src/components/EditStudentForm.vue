<template>
    <div>
        <form class="user" @submit="editNewStudentInfo">
            ...
            <input type="submit" value="Save Changes" class="btn btn-primary btn-block text-white btn-user">
        </form>
    </div>
</template>
...
export default {
    ...
    computed:mapGetters(['oneStudent']),
    data(){
            return{
                student:{
                    student_id:"", 
        ...
        methods: {
            ...mapActions(['getOneStudent','editOneStudent']), 
            editNewStudentInfo: function(e){
                e.preventDefault();
                ...
                this.student.school == "" ? (this.error.school = true, this.hasNoError = false): this.error.school = false;
                 ...
                 if(!this.hasNoError){
                    ...
                    this.editOneStudent(this.student);
                }
            },
            loadStudentData: function(){
                this.student.student_id = this.oneStudent.student_id,
                this.student.sender_number = this.oneStudent.sender_number, 
                this.student.first_name = this.oneStudent.first_name, 
                this.student.last_name = this.oneStudent.last_name, 
                this.student.phone_number = this.oneStudent.phone_number, 
                this.student.gender = this.oneStudent.gender, 
                this.student.address = this.oneStudent.address, 
                this.student.school = this.oneStudent.school,
                this.student.email = "sample@gmail.com"
            }
        },
        mounted(){
